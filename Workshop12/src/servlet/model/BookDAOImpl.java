...
public class BookDAOImpl implements BookDAO {
	...
	public ArrayList<Book> findBooks() throws SQLException {
		...
		try {
			...
			while (rs.next()) {
				temp.add(new Book(rs.getString("isbn"), rs.getString("title"), rs.getString("catalogue"),
	...
	public Book bookDesc(String isbn) throws SQLException {
		...
		try {
			...
			rs = ps.executeQuery();
			if(rs.next())
			book = new Book(rs.getString("isbn"), rs.getString("title"), rs.getString("catalogue"),
					rs.getString("nation"), rs.getString("publish_date"), rs.getString("publisher"),
					rs.getString("author"), rs.getInt("price"), rs.getString("description"));
		} finally {
			closeAll(rs, ps, conn);
