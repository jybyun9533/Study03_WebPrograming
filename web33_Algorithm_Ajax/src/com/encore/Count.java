...
public class Count {
	...
	/*
	 * public static void main(String[] args) { String book1
	 ...
	 * ; String book3 ="I like cat. I like cat. I like cat. "; Count c = new
	 * Count(); System.out.println(c.execute(book1));
	 * System.out.println(c.execute(book2)); System.out.println(c.execute(book3));
	 * 
	 * }
	 */
